"""
Django settings for excel_ap project.
...
SECRET_KEY = 'django-insecure-((kg=@-kpyi)30=ymeuhipo7idrgez59i*m$e0y$ada$n4!u9z'
...
WSGI_APPLICATION = 'excel_ap.wsgi.application'
